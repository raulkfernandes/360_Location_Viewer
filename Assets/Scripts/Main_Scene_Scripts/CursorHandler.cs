...
{
    [SerializeField] MenuSelectionHandler interfaceSelectionHandler;
    ...
    public void ResetObjectSelection()
    {
        ...
        {
            EventSystem.current.SetSelectedGameObject(this.interfaceSelectionHandler.GetCurrentGameObjectSelected());
        }
    }
}
